    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m2_net', models.DecimalField(decimal_places=2, max_digits=10)),
                ('durum', models.CharField(default='uygun', max_length=255)),
                ('user_id', models.CharField(default='None', max_length=255)),
                ('bekleme_suresi_baslangic', models.DateField(blank=True, null=True)),
                ('bekleme_suresi_bitisi', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parcel_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.parcel')),
            ],
        ),
        migrations.CreateModel(
